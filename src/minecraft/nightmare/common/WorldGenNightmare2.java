...
public class WorldGenNightmare2 extends WorldGenerator
{
    ...
    public WorldGenNightmare2(int par1, int par2)
    {
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && par1World.getBlockId(var38, var41, var44) == mod_Nightmare.nightmareStone.blockID)
                                {
        ...
        for(int a= 0; a < 20; a++)
		  {
		  		int randPosX = par4 + par2Random.nextInt(16); 
		  		int randPosY = par2Random.nextInt(3 + 200); 
		  		int randPosZ = par5 + par2Random.nextInt(16); 
		  		(new WorldGenNightmare2(mod_Nightmare.nightmareGrass.blockID, 15)).generate(par1World, par2Random, randPosX, randPosY, randPosZ); 
		  }
        BiomeGenBase biome = par1World.getWorldChunkManager().getBiomeGenAt(par3, par5); 
	      WorldGenNightmareTrees tree = new WorldGenNightmareTrees(true); 
	      if(biome instanceof BiomeGenNightmare)
	      { 
	      	for(int a = 0; a < 8; a++)
	      	{
