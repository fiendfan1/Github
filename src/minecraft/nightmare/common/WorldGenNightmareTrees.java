...
public class WorldGenNightmareTrees extends WorldGenerator
{
    ...
    public WorldGenNightmareTrees(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public WorldGenNightmareTrees(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
        field_48202_a = par2;
        field_48201_c = par3;
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
            ...
            for (int l = par3 - byte0; l <= par3 + byte0 && flag; l++)
            {
                for (int j1 = par5 - byte0; j1 <= par5 + byte0 && flag; j1++)
                {
                    if (j >= 0 && j < 256)
                    {
                        ...
                        if (j2 != 0 && j2 != mod_Nightmare.nightmareLeaf.blockID && j2 != mod_Nightmare.nightmareGrass.blockID && j2 != mod_Nightmare.nightmareGrass.blockID && j2 != mod_Nightmare.nightmareLog.blockID)
                        {
                            flag = false;
                        }
                    }
        ...
        if (k != mod_Nightmare.nightmareGrass.blockID && k != mod_Nightmare.nightmareGrass.blockID || par4 >= 256 - i - 1)
        {
            return false;
        }

        par1World.setBlock(par3, par4 - 1, par5, mod_Nightmare.nightmareGrass.blockID);
        byte byte1 = 3;
        int i1 = 0;
        ...
        for (int k1 = (par4 - byte1) + i; k1 <= par4 + i; k1++)
        {
            ...
            for (int l3 = par3 - j3; l3 <= par3 + j3; l3++)
            {
                ...
                for (int l4 = par5 - j3; l4 <= par5 + j3; l4++)
                {
                    ...
                    {
                        setBlockAndMetadata(par1World, l3, k1, l4, mod_Nightmare.nightmareLeaf.blockID, field_48199_d);
                    }
                }
            }
        }
        ...
        for (int l1 = 0; l1 < i; l1++)
        {
            ...
            if (l2 != 0 && l2 != mod_Nightmare.nightmareLeaf.blockID)
            {
                continue;
            }

            setBlockAndMetadata(par1World, par3, par4 + l1, par5, 	mod_Nightmare.nightmareLog.blockID, 1);
        ...
        if (field_48200_b)
        {
            for (int i2 = (par4 - 3) + i; i2 <= par4 + i; i2++)
            {
                ...
                for (int i4 = par3 - k3; i4 <= par3 + k3; i4++)
                {
                    ...
                    {
                        if (par1World.getBlockId(i4, i2, k4) != mod_Nightmare.nightmareLeaf.blockID)
                        {
                            continue;
                        }
