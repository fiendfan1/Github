...
public abstract class ServerConfigurationManager
{
    ...
    public void playerLoggedIn(EntityPlayerMP par1EntityPlayerMP)
    {
        ...
        while (var3.hasNext())
        {
            ...
            par1EntityPlayerMP.serverForThisPlayer.sendPacketToPlayer(new Packet201PlayerInfo(var4.username, true, var4.ping));
        }
    }
    ...
    {
		/**DIMENSION API EDIT**/
		WorldProvider worldprovider = par1EntityPlayerMP.worldObj.provider;
		WorldProviderBase worldproviderbase = null;
		if(worldprovider instanceof WorldProviderBase)
		{
			worldproviderbase = (WorldProviderBase)worldprovider;
			par2 = worldproviderbase.respawnInDimension();
			worldproviderbase.beforeRespawnTeleportation(mcServer, par1EntityPlayerMP);
			EntityPlayerMP newPlayer = worldproviderbase.overrideRespawn(mcServer, this, par1EntityPlayerMP, par2, par3);
			if(newPlayer != null)
			{
				return newPlayer;
			}
		...
		/**DIMENSION API EDIT**/
		if(worldproviderbase != null)
		{
			worldproviderbase.afterRespawnTeleportation(mcServer, var6);
		}
		/**END EDIT**/
        return var6;
    }
    ...
    public void transferPlayerToDimension(EntityPlayerMP par1EntityPlayerMP, int par2, Teleporter teleporter)
    {
		...
		/**DIMENSION API EDIT**/
        WorldProvider pOld = WorldProvider.getProviderForDimension(var3);//DimensionManager.getProvider(var3);
        WorldProvider pNew = WorldProvider.getProviderForDimension(par2);//DimensionManager.getProvider(par2);
		/**END EDIT**/
    ...
    /**DIMENSION API EDIT**/public/**END EDIT**/ void func_72381_a(EntityPlayerMP par1EntityPlayerMP, EntityPlayerMP par2EntityPlayerMP, World par3World)
    {
