...
public class WorldChunkManagerNightmare implements IChunkProvider
{
    ...
    public WorldChunkManagerNightmare(World par1World, long par2, boolean par4)
    {
                    ...
                    for (int var31 = 0; var31 < 8; ++var31)
                    {
                        ...
                        for (int var42 = 0; var42 < 4; ++var42)
                        {
                            ...
                            for (int var51 = 0; var51 < 4; ++var51)
                            {
                                if ((var47 += var49) > 0.0D)
                                {
                                    par3ArrayOfByte[var43 += var44] = (byte)mod_Nightmare.nightmareStone.blockID;
                                }
            ...
            for (int var9 = 0; var9 < 16; ++var9)
            {
                ...
                for (int var16 = 127; var16 >= 0; --var16)
                {
                    ...
                    else
                    {
                        ...
                        else if (var18 != mod_Nightmare.nightmareStone.blockID)
                        {
                            if (var13 == -1)
                            {
                                if (var12 == 0)
                                {
                                    var14 = 0;
                                    var15 = (byte)mod_Nightmare.nightmareStone.blockID;
                                }
