...
public class EntityCustomPortalFX extends EntityFX
{
    ...
    public EntityCustomPortalFX(World par1World, float red, float green, float blue, double par2, double par4, double par6, double par8, double par10, double par12)
    {
