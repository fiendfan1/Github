...
public final class ItemStack
{
    ...
    public boolean tryPlaceItemIntoWorld(EntityPlayer par1EntityPlayer, World par2World, int par3, int par4, int par5, int par6, float par7, float par8, float par9)
    {
		...
		/**DIMENSION API EDIT**/
		if(DimensionAPI.itemUseMap.containsKey(itemID))
		{
			par1EntityPlayer.addStat(StatList.objectUseStats[itemID], 1);
			IItemUse[] iitemuse = (IItemUse[])DimensionAPI.itemUseMap.get(itemID);
			for(IItemUse itemUseHooks : iitemuse)
			{
				itemUseHooks.onItemUse(this, par1EntityPlayer, par2World, par3, par4, par5, par6);
			}
			return true;
		}
		/**END EDIT**/
    ...
    {
		/**DIMENSION API EDIT**/
		if(DimensionAPI.itemRightClickMap.containsKey(itemID))
		{
			IItemRightClick[] iitemrightclick = (IItemRightClick[])DimensionAPI.itemRightClickMap.get(itemID);
			ItemStack itemstack = null;
			for(IItemRightClick itemRightClickHooks : iitemrightclick)
			{
				itemstack = itemRightClickHooks.onItemRightClick(this, par1World, par2EntityPlayer);
			}
			return itemstack;
		}
		/**END EDIT**/
