        ...
        for (int i1 = 0; i1 < par4; i1++)
        {
            for (int j1 = 0; j1 < par3; j1++)
            {
                ...
                if (k2 == 0 && (k1 != 0 || l1 != 0 || i2 != 0 || j2 != 0))
                {
					...
					if(i3 >= 0)
					{
						ocean = worldProvider.setOceanBiomes(BiomeGenBase.biomeList[i3], this);
					} else
					{
						ocean = worldProvider.setOceanBiomes(null, this);
					}
					if(ocean != null)
					{
                ...
                if (k2 > 0 && (k1 == 0 || l1 == 0 || i2 == 0 || j2 == 0))
                {
                    if (nextInt(5) == 0)
                    {
                        BiomeGenBase ocean = worldProvider.setOceanBiomes(BiomeGenBase.biomeList[k2], this);
						if(ocean != null)
						{
							ai1[j1 + i1 * par3] = ocean.biomeID;
						}
